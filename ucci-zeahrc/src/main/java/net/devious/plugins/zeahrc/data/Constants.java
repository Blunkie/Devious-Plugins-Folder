...
public class Constants {
    ...
    public static final String DenseEssenceBlock = "Dense essence block";
    public static final String DarkAltar = "Dark altar";
    public static final String EssenceFragments = "Dark essence fragments";
}
